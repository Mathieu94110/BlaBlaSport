        ...
        return (
            ...
            <div>
                ...
                <header className="header">
						<div className="container">
							<div className="row">
								...
								<div className="col-md-8">
									...
									<div className="nav">
										<div style={{"flex":1}}>
											<Button color="link" className="link" href="/user-template" ></Button>
										</div>
										<div style={{"flex":1}}>
                    ...
                    <div>
                        <Button color="primary" onClick={this.redirectNewsport}>Creer un sport</Button>
                    </div>
                    ...
                    <Container>
                        <Row style={{textAlign:'center'}}>
                            <Col md={3}>
                                ...
                                <div><p>Football</p><p>Prochaine séance prévue dans</p></div>
                            </Col>

                            <Col md={3}><img className="sportImage" src="/static/images/basket-ball.png"/>
                            <div><p>basket-ball</p><p>Prochaine séance prévue dans</p></div>
                            </Col>
                            
                            <Col md={3}><img className="sportImage" src="/static/images/tennis.png"/>
                            <div><p>Tennis</p><p>Prochaine séance prévue dans</p></div>
                            </Col>
                            
                            <Col md={3}><img className="sportImage" src="/static/images/baseball.png"/>
                            <div><p>Baseball</p><p>Prochaine séance prévue dans</p></div>
                            </Col>
                        </Row>
                        <Row>
                            {sports}
